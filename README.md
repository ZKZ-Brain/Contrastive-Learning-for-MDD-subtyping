...
* [d_result_of_z/](d_result_of_z/)
Save latent features of input data, extracted by '[e_extract_latent_feature](source/e_extract_latent_feature)'
  * [latent_z_train](d_result_of_z/latent_z_train.npz), [latent_z_test](d_result_of_z/latent_z_test.npz), [latent_z_rTMS](d_result_of_z/latent_z_rTMS.npz).  latent z for the trainset, testset and rTMS set respectively, dimension=32
  * [latent_z_train512](d_result_of_z/latent_z_train512.zip), [latent_z_rTMS512](d_result_of_z/latent_z_rTMS512.npz). latent z for the trainset and rTMS set respectively,  dimension=512
